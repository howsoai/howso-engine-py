...
class CasesWithDetails(collections.abc.MutableMapping):
    """
    ...
    KNOWN_KEYS = {
        ...
        "categorical_action_probabilities", "context_values",
    ...
    def __init__(self,
                 action: t.Optional[pd.DataFrame] = None,
    ...
    def gen_cases(self) -> t.Generator[Reaction, None, None]:
        """
