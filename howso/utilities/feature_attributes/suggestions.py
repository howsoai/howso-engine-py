...
class FeatureAttributesSuggestion(ABC):
    """Base class for a rich "suggestion" of potential improvements for computed feature attributes."""
    ...
    @property
    def title(self) -> str:
        """A brief title for this suggestion."""
        return self._title

    @property
    def description(self):
        """A full description of this suggestion and available callables."""
        return self._description

    @abstractmethod
    def apply(self, feature_attributes: SingleTableFeatureAttributes):
        """Apply this suggestion to the feature attributes object."""

    def print():
        # TODO override print for title + description?
